...
var deserializeError = function(value) {
    var ErrorConstructor = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Error;
    var parsed = typeof value === "string" ? JSON.parse(value) : value;
    if (parsed === null || parsed === void 0 ? void 0 : parsed.__isError) {
        var err = new ErrorConstructor(parsed.message);
